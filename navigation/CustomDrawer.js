...
import { setSelectedTab, setSelectedTabSuccess } from '../stores/tab/tabActions';
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <Text style={{ color: COLORS.transparentBlack7, ...FONTS.h3 }}>
                ...
                >
                    ...
                    <CustomDrawerItem
                        label={"Баптаулар"}
                        icon={icons.setting}
                        isFocused={selectedTab == "Баптаулар"}
                        onPress={() => {
                            setSelectedTab("Баптаулар")
                            navigation.navigate("MainLayout")
                        }}
                    />
                    {/* <CustomDrawerItem
                ...
                >
                    <CustomDrawerItem
                        label={"Шығып кетсін ба"}
                        icon={icons.logout}
                        isFocused={selectedTab == "Шығу"}
                        onPress={() => {
                            setSelectedTab("Шығу")
                            navigation.navigate("MainLayout")
                        }}
